...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cardstack = __webpack_require__(159);
	...
	var App = function App(props) {
	  return _react2.default.createElement(
	    ...
	    { height: 500, width: 400, background: '#f8f8f8', hoverOffset: 25 },
	    ...
	    _react2.default.createElement(_cardstack.Card, { background: '#27AE60' }),
	    _react2.default.createElement(_cardstack.Card, { background: '#9B27AE' }),
	    _react2.default.createElement(_cardstack.Card, { background: '#e67e22' })
	  );
	};
	...
	var ProfilePicture = function ProfilePicture(_ref) {
	  ...
	  return _react2.default.createElement('img', { style: { width: '60px', height: '60px',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CardStack = function (_React$Component2) {
	  _inherits(CardStack, _React$Component2);

	  function CardStack(props) {
	    _classCallCheck(this, CardStack);

	    var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(CardStack).call(this, props));

	    var childrenLength = props.children.length || 1;
	    var headerHight = props.height / childrenLength;

	    _this2.initTopOffsets = props.children.map(function (child, i) {
	      return equalsZero(i) ? 0 : headerHight * i;
	    });
	    _this2.state = {
	      topOffsets: _this2.initTopOffsets,
	      cardSelected: false
	    };
	    return _this2;
	  }
	  ...
	  _createClass(CardStack, [{
	    ...
	    value: function handleCardClick(id, cb) {
	      ...
	      this.setState(this.state.topOffsets.reduce(function (prev, offset, index) {
	        var newOffset = id === index ? 0 : _this3.props.height;

	        if (_this3.state.cardSelected) {
	          prev.cardSelected = false;
	          newOffset = _this3.initTopOffsets[index];
	        }
	    ...
	    value: function renderCards() {
	      ...
	      return this.props.children.map(function (child, i) {
	        return _react2.default.cloneElement(child, {
	          key: i,
	          cardId: i,
	          hoverOffset: _this4.props.hoverOffset,
	          cardSelected: _this4.state.cardSelected,
	          height: _this4.props.height,
	          topOffsets: _this4.state.topOffsets[i],
	          handleClick: _this4.handleCardClick.bind(_this4)
	        });
	      });
	    }
	  }, {
